...
# keyboard
screen.listen()
screen.onkeypress(paddle_up("paddle_1"), "w")
screen.onkeypress(paddle_down("paddle_1"), "s")
screen.onkeypress(paddle_up("paddle_2"), "Up")
screen.onkeypress(paddle_down("paddle_2"), "Down")
